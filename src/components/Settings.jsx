              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div className="space-y-3">
                  <p className="text-sm text-blue-700 dark:text-blue-300 mb-3">
                    Choose which backend to use for Claude provider
                  </p>
                  <select
                    value={claudeBackend}
                    onChange={(e) => setClaudeBackend(e.target.value)}
                    className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-foreground"
                  >
