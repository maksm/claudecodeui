...
import { getGitHubPRInfo } from '../utils/github-pr.js';
...
// Check for open pull requests for the current branch
router.get('/pr-status', async (req, res) => {
  ...
  try {
    ...
    // Get PR info using utility function
    const prInfo = await getGitHubPRInfo(projectPath, branch);
